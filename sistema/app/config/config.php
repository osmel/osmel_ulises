...
$config['sess_cookie_name']		= 'copa_session';
...
$config['sess_table_name']		= 'copa_sessions'; //'ci_sessions';
...
| addresses from which CodeIgniter should trust the HTTP_X_FORWARDcopa_FOR
