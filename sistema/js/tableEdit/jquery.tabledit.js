 ...
 *  @requires jQuery 1.4+ - jQuery 1.7+ is recommended
...
fieldTypes.readonly = $.extend( true, {}, baseFieldType, {
	"create": function ( conf ) {
		conf._input = $('<input id="'+conf.id+'" readonly="readonly">')[0];
		return conf._input;
	}
} );
...
fieldTypes.text = $.extend( true, {}, baseFieldType, {
	"create": function ( conf ) {
		conf._input = $('<input id="'+conf.id+'">')[0];
		return conf._input;
	}
} );
...
fieldTypes.password = $.extend( true, {}, baseFieldType, {
	"create": function ( conf ) {
		conf._input = $('<input id="'+conf.id+'" type="password">')[0];
		return conf._input;
	}
} );
...
fieldTypes.textarea = $.extend( true, {}, baseFieldType, {
	"create": function ( conf ) {
		conf._input = $('<textarea id="'+conf.id+'">')[0];
		return conf._input;
	}
} );
...
fieldTypes.select = $.extend( true, {}, baseFieldType, {
	...
	"_addOptions": function ( conf, opts ) {
		var elOpts = conf._input.options;
	...
	"create": function ( conf ) {
		conf._input = $('<select id="'+conf.id+'">')[0];
